...
export function Signup(){
    return <div className="w-screen h-screen grid grid-cols-2" style={{backgroundImage:`url(${bgimg})` ,backgroundSize: 'cover' ,}}>
<div className="flex justify-center items-center text-5xl font-bold text-white  " style={{filter: 'none'}}>OPD-m</div>
<div className="flex justify-start items-center p-10 " style={{filter: 'none'}}>
    <div className="h-full w-2/3 bg-white rounded-xl p-10 ">
...
<select name="what is your role ?" id="">what is your role ?
...
<button className="px-6 py-2 rounded-full bg-blue-600 text-white font-bold hover:bg-sky-700">Continue</button>
</div>
</div>
</div>
    </div>
